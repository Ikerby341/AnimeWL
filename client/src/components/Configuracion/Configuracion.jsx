...
import { useDadesUsuari } from './../../hooks/useAuth';
import { useNotificacio } from '../../hooks/useToast.js';
import { IconaLlapis } from '../Icons/Icons.jsx';
...
function Configuracio() {
  ...
  let userInfo = useDadesUsuari();

  function canviarNomUsuari() {
  ...
  function enviarCodiVerificacioCorreu() {
  ...
  function canviarCorreuElectronic() {
  ...
  return (
    <div className="configuracion">
            ...
            <button className="save-button" onClick={canviarNomUsuari} aria-label="Editar nombre de usuario" title="Editar nombre de usuario">
                <IconaLlapis />
            </button>
            <br />
      ...
      <div className="modal-overlay">
            ...
            onClick={enviarCodiVerificacioCorreu}
            disabled={isSendCodeDisabled}>
            
                            {isSendCodeDisabled ? 'Puedes solicitar otro código en 60s' : 'Enviar código al correo actual'}
                        </button>
                        <div className="modal-actions">
                            <button className="change-button" onClick={canviarCorreuElectronic}>Cambiar correo</button>
                        </div>
                    </div>
                </div>
      }
            ...
            <br />
            <button className="change-button" onClick={canviarContrasenya}>Cambiar contraseña</button>
        </div>);
