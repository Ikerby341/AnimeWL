...
function obtenirIdUsuariComentari(comment) {
...
function formatarDataComentari(value) {
  if (!value) return '';
...
function ComentarisAnime({ animeId, comments, loading, isLoggedIn, currentUserId, currentUserIsAdmin = false, onCommentAdded, onCommentDeleted }) {
  ...
  const eliminarComentari = async (commentId) => {
    if (!commentId) return;
    setDeleteError('');
  ...
  return (
    <section className="anime-comments-section">
      ...
      <div className="comment-create-block">
        ...
        <form className="comment-form" onSubmit={enviarFormulari}>
                            <textarea
      ...
      <div className="comments-empty">Aún no hay comentarios para este anime.</div>
          ...
          const commentUserId = obtenirIdUsuariComentari(comment);
          ...
          return (
            <article key={comment.id_comentari} className="comment-card">
                ...
                <div className="comment-user-info">
                                ...
                                <p className="comment-date">{formatarDataComentari(comment.data_hora)}</p>
                            </div>
              ...
              <div className="comment-delete-row">
                  ...
                  onClick={() => eliminarComentari(comment.id_comentari)}
