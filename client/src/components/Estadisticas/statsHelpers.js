...
export function buildPieSegments(topGenres = [], pieColors = []) {
...
export function buildPieBackground(pieSegments = []) {
...
export function calculateBarHeight(minutes = 0, maxMinutes = 1, minBarRatio = 0.02) {
